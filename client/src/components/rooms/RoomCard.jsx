...
const RoomCard = ({
  ...
  return (
    <div className="col-span-1 border flex flex-col border-[#007370] rounded-md">
      <div className="py-4 text-center rounded-t-md font-semibold bg-[#007370] text-white px-6">{title}</div>
      <div className="flex flex-col flex-auto gap-2 p-4 items-center justify-between">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col mt-4 gap-2">
            <span className="text-[#007370] underline">Tiện nghi:</span>
        ...
        {position === "Còn trống" && (
          <div className="my-4 w-full">
            <Button
              onClick={handleOrder}
              className="bg-transparent border w-full font-medium border-[#007370] text-[#007370]"
            >
              Thuê phòng
            </Button>
          </div>

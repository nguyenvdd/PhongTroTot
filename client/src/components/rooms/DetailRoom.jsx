  ...
  return (
    ...
    >
      <h1 className="text-2xl font-semibold p-4 border-b">
        Chi tiết phòng <span className="text-[#007370]">{room?.title}</span>
      </h1>
      <div className="p-4">
        Phòng trọ đang thuộc tin đăng{" "}
        <Link
          to={`/${pathname.public.DETAIL_POST}/${room?.rPost?.id}/${room?.rPost?.title}`}
          className="text-[#007370] hover:underline"
        >
          {room?.rPost?.title}
        </Link>
      </div>
                ...
                <td className="flex items-center gap-2 border p-3 text-center">
                  {el.isPayment ? (
                    <span
                      ...
                      className="flex justify-center items-center hover:text-[#007370]"
                    >
                    ...
                    <span
                      ...
                      className="flex justify-center items-center cursor-pointer hover:text-[#007370]"
                    >

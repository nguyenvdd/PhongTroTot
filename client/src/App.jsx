...
import { CanHo, Checkout, DetailPost, Home, Login, PhongTro, PublicLayout, TimGhep, TimPhong, YeuThich } from "./pages/public"
import { useAppStore, useUserStore } from "./store"
import { CreatePostUser, MyRoom, Profile, UserLayout, ViewContract } from "./pages/user"
    ...
    >
      ...
      <Routes>
        ...
        <Route path={pathname.public.LAYOUT} element={<PublicLayout />}>
          ...
          <Route path={pathname.public.YEUTHICH} element={<YeuThich />} />
          <Route path={pathname.public.TIMPHONG} element={<TimPhong />} />
        ...
        <Route path={pathname.public.QUENMATKHAU} element={<ForgotPassword />} />
        <Route path={pathname.public.DATLAIMATKHAU} element={<ResetPassword />} />
        ...
        <Route path={pathname.user.LAYOUT} element={<UserLayout />}>
          ...
          <Route path={pathname.user.CREATE_POST} element={<CreatePostUser />} />
        </Route>
